<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AdminCustomerManagement.aspx.cs" Inherits="Online_Pizza_Delivery_System.AdminCustomerManagement" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100" src="Images/Admin/22.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-8">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Full Name" ReadOnly="True" Width="400px"></asp:TextBox>
                        </div>
                     </div>
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:LinkButton class="btn btn-success mr-1" ID="LinkButton5" runat="server"><i class="fas fa-check-circle"></i></asp:LinkButton>
                              <asp:LinkButton class="btn btn-warning mr-1" ID="LinkButton6" runat="server"><i class="far fa-pause-circle"></i></asp:LinkButton>
                              <asp:LinkButton class="btn btn-danger mr-1" ID="LinkButton7" runat="server"><i class="fas fa-times-circle"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                  </div>     
                  ...
                  <div class="row">
                     <div class="col-12">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox6" runat="server" placeholder="Full Postal Address" TextMode="MultiLine" Rows="3" ReadOnly="True" Width="650"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-8 mx-auto">
                        <br><asp:Button ID="Button2" class="btn btn-lg btn-block btn-danger" runat="server" Text="Delete User Permanently"  />
                     </div>
                  </div>
               </div>
            </div>
